...
%define CoordXarvore 280
%define CoordYarvore 175

%define CoordXarvore2 175
%define CoordYarvore2 175
...
lose	db	'-Desvie dos obstaculos para ganhar o jogo.', 0
...
loop_game:
	...
	mov dx, CoordYarvore
	mov cx, CoordXarvore
	call salvar_posicao_arvore
	call print_arvore

	;printando arvore 2
	mov dx, CoordYarvore2
	mov cx, CoordXarvore2
	call salvar_posicao_arvore2
	call print_arvore
	...
	.main_loop:
		...
		call carregar_score_player
		cmp ax, 3000 ;quanto para ganhar
		jg tela_venceu
		...
		;apagando a arvore1 da posicao atual
		call carregar_posicao_arvore
		call apagar_arvore

		;printando arvore1 na margem da pista
		call carregar_posicao_arvore
		call carregar_velocidade
		sub cx, ax
		
		;verificando se a arvore saiu do mapa
		cmp cx, 5
		jl .reseta_arvore
		...
		;apagando a arvore2 da posicao atual
		call carregar_posicao_arvore2
		call apagar_arvore	
		
		;printando arvore2 na margem da pista
		call carregar_posicao_arvore2
		call carregar_velocidade
		sub cx, ax
